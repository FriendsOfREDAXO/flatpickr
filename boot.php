...
if (rex::isBackend() && is_object(rex::getUser())) {
    ...
    rex_view::addJsFile($addon->getAssetsUrl('vendor/flatpickr/dist/flatpickr.min.js'));
    rex_view::addJsFile($addon->getAssetsUrl('vendor/flatpickr/dist/l10n/de.js'));
    rex_view::addJsFile($addon->getAssetsUrl('vendor/flatpickr/dist/plugins/rangePlugin.js'));
